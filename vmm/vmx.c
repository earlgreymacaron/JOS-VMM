...
void vmexit() {
	...
	case EXIT_REASON_VMCALL:
		exit_handled = handle_vmcall(&curenv->env_tf, &curenv->env_vmxinfo, curenv->env_pml4e);
		break;
...
asm(
     ...
     * above.
     */
    /* This is not the first run => VMRESUME */
    "je 3f \n\t"
    /* This is the first run => VMLAUNCH */
    "jmp 4f \n\t"
